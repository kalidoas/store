...
<div class="grid gap-6 lg:grid-cols-3">
    <form method="POST" action="{{ secure_url('/products') }}" enctype="multipart/form-data">
        @csrf
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <div>
                ...
                <input type="number" name="quantity" min="0" step="1" oninput="this.value=this.value.replace(/^0+(?=\d)/, '')" value="{{ old('quantity', 0) }}" class="mt-1 w-full rounded-lg border border-[#E5E7EB] px-3 py-2 text-sm" id="quantity">
            ...
            <div>
                ...
                <input type="number" step="any" min="0" oninput="this.value=this.value.replace(/^0+(?=\d)/, '')" name="purchase_price" value="{{ old('purchase_price', 0) }}" class="mt-1 w-full rounded-lg border border-[#E5E7EB] px-3 py-2 text-sm" id="purchase_price">
            ...
            <div>
                ...
                <input type="number" step="any" min="0" oninput="this.value=this.value.replace(/^0+(?=\d)/, '')" name="transport_fees" value="{{ old('transport_fees', 0) }}" class="mt-1 w-full rounded-lg border border-[#E5E7EB] px-3 py-2 text-sm" id="transport_fees">
            ...
            <div>
                ...
                <input type="number" step="any" min="0" oninput="this.value=this.value.replace(/^0+(?=\d)/, '')" name="other_fees" value="{{ old('other_fees', 0) }}" class="mt-1 w-full rounded-lg border border-[#E5E7EB] px-3 py-2 text-sm" id="other_fees">
            ...
            <div>
                ...
                <input type="number" step="any" min="0" oninput="this.value=this.value.replace(/^0+(?=\d)/, '')" name="selling_price" value="{{ old('selling_price', 0) }}" class="mt-1 w-full rounded-lg border border-[#E5E7EB] px-3 py-2 text-sm" id="selling_price">
